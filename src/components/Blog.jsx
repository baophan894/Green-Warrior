...
const Blog = () => {
    const blogs = [
        {id: 1, title: "24 Hours Without Plastic Bags", image: "/src/assets/blog1.png"},
        {id: 2, title: "Meatless Day", image: "/src/assets/blog2.png"},
        {id: 3, title: "24-Hour Air Emissions", image: "/src/assets/blog3.png"},
    ];
    return (
        <div  className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-12' id='faq'>
            ...
            Our positive actions towards the environment can have a profound and beneficial impact. 
            Each small action, even within a single day, can make a significant difference to the environment we live in.
            </p>
            </motion.div>
