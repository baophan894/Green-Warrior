...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      decription:
        "Choose and vote for the content that you interest the most",
    ...
    },
    {
      ...
      decription:
        "Join different club or host one to make our community",
    ...
    <div className="md:px-14 px-4 py-16 max-w-screen-2xl mx-auto" id="service">
      ...
      >
        ...
        <p className="text-neutralGrey">
          Challenges are waiting for you to conquer
        </p>
      ...
      >
        <h2 className="text-4xl text-neutralDGrey font-semibold mb-3">
          Together build a green community
        </h2>
        <p className="text-neutralGrey">
          You can do many thing to washing-up our earth
        </p>
      </motion.div>
